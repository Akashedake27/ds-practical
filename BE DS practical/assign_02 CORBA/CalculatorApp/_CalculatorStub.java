...
public class _CalculatorStub extends org.omg.CORBA.portable.ObjectImpl implements CalculatorApp.Calculator
{
  ...
  public float divide (float a, float b) throws CalculatorApp.DivisionByZero
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
                if (_id.equals ("IDL:CalculatorApp/DivisionByZero:1.0"))
                    throw CalculatorApp.DivisionByZeroHelper.read ($in);
                else
                    throw new org.omg.CORBA.MARSHAL (_id);
            } catch (org.omg.CORBA.portable.RemarshalException $rm) {
                return divide (a, b        );
